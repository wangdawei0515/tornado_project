...
def save_file(self, upload_file):
    ...
    if old_file is not None:
        file_path = 'http://106.14.163.146:8000/images/' + old_file.uuid
    ...
    self.db.add(files)
    self.db.commit()
    file_path = 'http://106.14.163.146:8000/images/' + files.uuid
...
def create_sharing_links_lib(self, file_uuid):
    ...
    return 'http:106.14.163.146:8000/files/files_auth_sharing_links?uuid=%s'%uu, password
